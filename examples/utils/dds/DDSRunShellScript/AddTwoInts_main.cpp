        ...
        char** argv)
{
    ...
    uint32_t count = 10;
    std::string service_name("RunShellScriptService");
    ...
    while (true)
    {
        ...
        switch (opt)
        {
            ...
            case 'h':
            {
                ...
                std::cout << "\t-n/--service_name\t(optional) Request/reply to/from a specific service (default: RunShellScriptService)" << std::endl;
                return 0;
            }
            default:
            {
